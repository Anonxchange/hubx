...
const TrendingPage = () => {
  ...
  // For now, we'll use the same hook but we can modify this to implement trending logic later
      ...
      <main className="container mx-auto px-4 py-6 space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            The hottest and most popular videos right now
          </p>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <span className="text-sm font-medium">Showing {totalCount} trending videos</span>
          </div>
          <div className="flex items-center space-x-2">
